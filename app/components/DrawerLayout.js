        ...
        <DrawerLayoutAndroid
          ...
          renderNavigationView={() => (
            <View style={style.wrapper}>
              <Text style={{marginVertical: 20, fontSize: 28, textAlign: 'center', color: '#007fff'}}>Web-WangDong</Text>
              ...
              {
                [
                  {url: 'https://github.com/wangdong1012', title: 'Github', icon: 'github'},
                  {url: 'https://www.baidu.com', title: '外链', icon: 'user'},
              ...
              <Text style={style.footer}>Copyright © 2017 WangDong</Text>
            </View>
          )}>
          {this.props.children}
        </DrawerLayoutAndroid>
